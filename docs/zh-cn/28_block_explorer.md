...
比原区块浏览器是查看比原链区块、交易、地址详细信息的主要工具。[点击访问](https://blockmeta.com/)

#### 搜索

![](./img/blockmeta-search.png)

可输入区块高度、地址、交易哈希来搜索详细信息。

#### 区块

![](./img/blockmeta-block.png)

[示例](https://blockmeta.com/block/88888)

区块页面主要展示区块详细信息，既包含区块高度、交易时间、区块哈希等区块基本信息，还展示了区块挖矿地址、难度等挖矿信息，同时也包含了该区块相关所有交易信息（可通过点击交易记录面板右侧展开按钮查看当前交易详情）。

#### 地址

![](./img/blockmeta-address.png)

[示例](https://blockmeta.com/address/bm1qcxg0w7c70tdd46t7dxn204mkyeyudcz063s49e)

地址页面主要展示该地址余额、总计接收、发送的比原数目，以及该地址交易总数和交易详情。

#### 交易

![](./img/blockmeta-tx.png)

[示例](https://blockmeta.com/tx/6a6d21bc5d16399c877875991a5a2706afff3ebdc458e7556b20fc05b012a258)

交易页面主要展示该交易所属区块高度、交易时间、数据大小、确认数、交易状态等信息。
...
- `String` - *address*, 账户下的地址

可选参数:

- `String` - *asset_id*, 资产id
- `Integer` - *page*, 页码
- `Integer` - *limit*, 每页的交易数量
