...
<a name="3d0a2df9-13"></a>
##### 参数

none

<a name="5f411223-13"></a>
##### 返回
...
<a name="5f411223-14"></a>
##### 返回

如果资产别名更新成功，则为none。

<a name="8cb94eb1-14"></a>
##### 例子
...
<a name="3d0a2df9-15"></a>
##### 参数

none

<a name="5f411223-15"></a>
##### 返回
...
<a name="3d0a2df9-17"></a>
##### 参数

none

<a name="5f411223-17"></a>
##### 返回
...
<a name="5f411223-18"></a>
##### 返回

如果恢复钱包成功，返回none

<a name="8cb94eb1-18"></a>
##### 例子
...
<a name="3d0a2df9-27"></a>
##### 参数

none

<a name="5f411223-27"></a>
##### 返回
...
<a name="5f411223-28"></a>
##### 返回

如果成功删除访问令牌，则为none。

<a name="8cb94eb1-28"></a>
##### 例子
...
<a name="5f411223-29"></a>
##### 返回

如果access token被选中有效，则为none。

<a name="8cb94eb1-29"></a>
##### 例子
...
<a name="5f411223-30"></a>
##### 返回

如果交易反馈已成功创建，返回none。

<a name="8cb94eb1-30"></a>
##### 例子
...
<a name="get-transaction-feed"></a>
#### get-transaction-feed

按名称查询交易反馈详细信息。

<a name="3d0a2df9-31"></a>
##### 参数
...
list-transaction-feeds<br />

返回所有可用交易反馈的列表。

<a name="3d0a2df9-32"></a>
##### 参数

none

<a name="5f411223-32"></a>
##### 返回
...
<a name="5f411223-33"></a>
##### 返回

如果交易反馈删除成功，则无返回.

<a name="8cb94eb1-33"></a>
##### 例子
...
update-transaction-feed<br />

更新交易反馈.

<a name="3d0a2df9-34"></a>
##### 参数
...
<a name="5f411223-34"></a>
##### 返回

如果交易反馈更新成功无返回.

<a name="8cb94eb1-34"></a>
##### 例子
...
list-unconfirmed-transactions<br />

返回缓冲池交易的总数和交易ID列表.

<a name="3d0a2df9-36"></a>
##### 参数

none

<a name="5f411223-36"></a>
##### 返回
...
<a name="3d0a2df9-38"></a>
##### 参数

none

<a name="5f411223-38"></a>
##### 返回
...
<a name="3d0a2df9-39"></a>
##### 参数

none

<a name="5f411223-39"></a>
##### 返回
...
<a name="3d0a2df9-44"></a>
##### 参数

无

<a name="5f411223-44"></a>
##### 返回
...
<a name="3d0a2df9-45"></a>
##### 参数

无

<a name="5f411223-45"></a>
##### 返回
...
<a name="3d0a2df9-47"></a>
##### 参数

无

<a name="5f411223-46"></a>
##### 返回
...
<a name="verify-message"></a>
#### verify-message

用地址派生的pubkey验证已签名的消息。

<a name="3d0a2df9-48"></a>
##### 参数
...
<a name="3d0a2df9-50"></a>
##### 参数

none

<a name="5f411223-49"></a>
##### 返回
...
<a name="5f411223-50"></a>
##### 返回

如果成功返回true

<a name="8cb94eb1-51"></a>
##### 例子
